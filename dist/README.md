...
|爱吾游戏宝盒|1|<li>青少年模式|
|安吉星|1|<li>开屏广告|
|安全服务/小米手机管家|10|<li>功能类-USB安装应用,自动点击[继续安装]<li>功能类-禁止获取定位<li>功能类-使用返回退出时直接点击[退出]<li>功能类-低电量提醒<li>功能类-高敏感权限自动确定<li>功能类-应用信息页-自启动提示<li>功能类-自动允许分享文件<li>功能类-自动关闭SIM卡安全保护验证提示<li>功能类-禁止后台运行弹窗<li>功能类-风险提示-仍然支付|
...
|不背单词|3|<li>功能类-自动签到<li>功能类-右下角年度报告弹窗<li>全屏广告-弹窗广告|
|不厌书法|1|<li>功能类-功能介绍|
|布丁扫描|1|<li>更新提示|
|布蕾4K|1|<li>通知提示-公告弹窗|
|步道乐跑|1|<li>全屏广告-弹窗广告|
...
|企查查|1|<li>全屏广告-VIP弹窗|
|企业微信|4|<li>功能类-自动领红包<li>分段广告-顶部卡片广告<li>权限提示-悬浮窗<li>功能类-自动打卡|
...
|小米音箱|3|<li>全屏广告-首页弹窗广告<li>权限提示-请求开启定位权限弹窗<li>全屏广告-弹窗广告|
...
|知乎|12|<li>开屏广告<li>分段广告-信息流广告<li>权限提示-通知权限<li>全屏广告-弹窗广告<li>局部广告-卡片广告<li>局部广告-信息流广告<li>局部广告-悬浮广告<li>更新提示<li>功能类-热榜页自动点击[展开更多]<li>功能类-自动展开回答<li>评价提示-评论区氛围评价卡片<li>权限提示-评论通知权限|
